...
public class SolicitudCotizanteRechazadoDTO {
	...
	public SolicitudCotizanteRechazadoDTO() {
		super();
	}

	public SolicitudCotizanteRechazadoDTO(String tipoDocumento, String numeroDocumento, String nombreCompleto,
