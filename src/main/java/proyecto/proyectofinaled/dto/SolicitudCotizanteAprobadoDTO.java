...
public class SolicitudCotizanteAprobadoDTO {
	...
	public SolicitudCotizanteAprobadoDTO() {
		super();
	}
	
	public SolicitudCotizanteAprobadoDTO(String tipoDocumento, String numeroDocumento, String nombreCompleto,
